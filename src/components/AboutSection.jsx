...
import photo1 from "../assets/unwatermarked_Gemini_Generated_Image_c2w2vgc2w2vgc2w2.webp";
import photo2 from "../assets/ChatGPT Image Mar 4, 2026 at 03_15_20 AM.webp";
import photo3 from "../assets/ChatGPT Image Mar 6, 2026 at 06_59_24 AM.webp";
import photo4 from "../assets/unwatermarked_unwatermarked_Gemini_Generated_Image_yv80p9yv80p9yv80.webp";
...
export default function AboutSection1() {
    ...
    return (
        <section
            id="about"
            className="relative py-32 px-4 dark:bg-zinc-950 bg-gray-50 overflow-hidden"
            ref={heroRef}
        >
            ...
            />
            <TimelineContent
                className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#a3a3a32e_1px,transparent_1px),linear-gradient(to_bottom,#a3a3a32e_1px,transparent_1px)] bg-[size:70px_70px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_100%,#000_70%,transparent_110%)] dark:bg-[linear-gradient(to_right,#3f3f462e_1px,transparent_1px),linear-gradient(to_bottom,#3f3f462e_1px,transparent_1px)]"
                animationNum={3}
                customVariants={revealVariants3}
                timelineRef={heroRef}
            />
            <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center">
                <div className="text-[#C3E41D] text-sm font-semibold uppercase mb-6 flex items-center justify-center gap-2">
                    About
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-gray-900 dark:text-gray-100 mb-6 w-full">
                    <VerticalCutReveal
                        splitBy="words"
                        staggerDuration={0.2}
                        staggerFrom="last"
                    ...
                    >
                        {
                            "Engineering Intelligence Into Real-World Solutions"
                        }
                    </VerticalCutReveal>
                </h2>
                <TimelineContent
                    ...
                    timelineRef={heroRef}
                    className="text-gray-600 dark:text-gray-400 text-center sm:text-lg text-sm mb-8 leading-relaxed"
                >
                    I am a Computer Science student specializing in Artificial Intelligence with a strong foundation in Java, Python, JavaScript, and Data Structures & Algorithms. I enjoy designing scalable systems, building automation workflows, and contributing to open-source projects.
                    <br /><br />
                    My interests span AI systems, cybersecurity fundamentals, backend architecture, and performance optimization. I focus on writing clean, maintainable code and understanding systems at a deeper level — not just using tools, but mastering them.
                </TimelineContent>
            </div>
            <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-4 gap-4 pt-20 lg:h-[26rem] md:h-[22rem] sm:h-[16rem] h-[14rem]">
                <TimelineContent
                    as="figure"
                    animationNum={2}
                    timelineRef={heroRef}
